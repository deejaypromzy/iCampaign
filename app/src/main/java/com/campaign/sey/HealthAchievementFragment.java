...
public class HealthAchievementFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        switch (service){
            case "health_ach":
                mref = mfirebaseDatabase.getReference().child(Utils.PERSON).child(Utils.HEALTH_ACHIEVEMENT);
                mref.keepSynced(true);
                break;
            case "health_vision":
                mref = mfirebaseDatabase.getReference().child(Utils.PERSON).child(Utils.HEALTH_VISION);
                mref.keepSynced(true);
                break;
        }
