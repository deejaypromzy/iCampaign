...
public class EducationAcheivementFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        switch (service){
            case "edu_ach":
                mref = mfirebaseDatabase.getReference().child(Utils.PERSON).child(Utils.EDUCATIONAL_ACHIEVEMENT);
                mref.keepSynced(true);

                break;
            case "edu_vision":
                mref = mfirebaseDatabase.getReference().child(Utils.PERSON).child(Utils.EDUCATIONAL_VISION);
                mref.keepSynced(true);
