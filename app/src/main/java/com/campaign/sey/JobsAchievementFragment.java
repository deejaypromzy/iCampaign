...
public class JobsAchievementFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        switch (service){
            case "job_ach":
                mref = mfirebaseDatabase.getReference().child(Utils.PERSON).child(Utils.JOB_ACHIEVEMENT);
                mref.keepSynced(true);
                break;
            case "job_vision":
                mref = mfirebaseDatabase.getReference().child(Utils.PERSON).child(Utils.JOB_VISION);
                mref.keepSynced(true);
                break;
        }
